...
// document.addEventListener('DOMContentLoaded', () => {
  ...
  const textRules = document.createTextNode("You've been working too hard! Take a paws and enjoy these cute dog pictures. Click anywhere on the border of the dog picture to destress during this ruff time.")
